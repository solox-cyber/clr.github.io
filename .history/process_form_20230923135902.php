...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    ini_set('SMTP', 'clresources2019@gmail.com'); // Replace with your SMTP server address
    ini_set('smtp_port', 587); // Replace with your SMTP server port (usually 587 for TLS/STARTTLS)
